...
var tileSchema = mongoose.Schema({
    ...
    farms: [{ directions: [String], meepleOffset: { x: Number, y: Number }}],
    cloister: Boolean,
...
tileSchema.statics.loadTiles = function() {
	...
	Tile.remove({}, function() {
		...
		Tile.create({
			...
			farms: [{ directions: ['WNW','ENE'], meepleOffset: { x: 1/8, y: 5/16 }},
			...
			roads: [],
			cities: [{ directions: ['N'], meepleOffset: { x: 1/2, y: 1/8 }}],
			farms: [{ directions: ['WNW','WSW','SSW','SSE','ESE','ENE'], meepleOffset: { x: 1/2, y: 5/8 }}],
			cloister: false,
			doublePoints: false,
			...
			farms: [{ directions: ['SSW','SSE','ESE','ENE'], meepleOffset: { x: 5/8, y: 5/8 }}],
			cloister: false,
			doublePoints: false,
			...
			farms: [{ directions: ['WNW','WSW','ENE','ESE'], meepleOffset: { x: 1/4, y: 1/2 }}],
			cloister: false,
			doublePoints: false,
			...
			farms: [{ directions: ['NNW','NNE'], meepleOffset: { x: 1/2, y: 1/16 }},
			        { directions: ['SSW','SSE'], meepleOffset: { x: 1/2, y: 7/8 }}],
			cloister: false,
			doublePoints: true,
			...
			cities: [{ directions: ['N'], meepleOffset: { x: 1/2, y: 1/8 }}],
			farms: [{ directions: ['WNW','WSW','SSW','ENE'], meepleOffset: { x: 1/4, y: 5/8 }},
			        { directions: ['SSE','ESE'], meepleOffset: { x: 13/16, y: 13/16 }}],
			cloister: false,
			doublePoints: false,
			...
			farms: [{ directions: ['SSW','SSE','ESE','ENE'], meepleOffset: { x: 11/16, y: 11/16 }}],
			cloister: false,
			doublePoints: true,
			...
			cities: [{ directions: ['N','W'], meepleOffset: { x: 1/4, y: 1/4 }}],
			farms: [{ directions: ['SSW','ENE'], meepleOffset: { x: 9/16, y: 9/16 }},
			...
			farms: [{ directions: ['SSW','SSE'], meepleOffset: { x: 1/2, y: 7/8 }}],
			cloister: false,
			doublePoints: true,
			...
			cities: [{ directions: ['N','E','W'], meepleOffset: { x: 1/2, y: 3/8 }}],
			farms: [{ directions: ['SSW'], meepleOffset: { x: 5/16, y: 7/8 }},
			        { directions: ['SSE'], meepleOffset: { x: 3/4, y: 7/8 }}],
			cloister: false,
			doublePoints: true,
			...
			cities: [{ directions: ['N'], meepleOffset: { x: 1/2, y: 1/8 }}],
			farms: [{ directions: ['WNW','ENE','ESE','SSE'], meepleOffset: { x: 3/4, y: 1/2 }},
			        { directions: ['SSW','WSW'], meepleOffset: { x: 1/4, y: 3/4 }}],
			cloister: false,
			doublePoints: false,
